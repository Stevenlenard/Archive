...
function initializeButtons() {
  ...
  // Logout button - if header already provides centralized `.js-logout-action`, let it handle the click
  const logoutBtn = document.getElementById("logoutBtn")
  if (logoutBtn && !logoutBtn.classList.contains('js-logout-action')) {
