...
function initializeButtons() {
  ...
  const notificationsBtn = document.getElementById("notificationsBtn") || document.getElementById("janitorNotificationsBtn")
  if (notificationsBtn) {
    notificationsBtn.addEventListener("click", (e) => {
      e.preventDefault()
      if (typeof openNotificationsModal === 'function') openNotificationsModal()
      else window.location.href = (notificationsBtn.id === 'janitorNotificationsBtn') ? 'janitor-alerts.php' : 'notifications.php'
    })
  }
