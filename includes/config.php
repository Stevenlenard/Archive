...
// ==========================
// iPROGSMS SMS SETTINGS
// ==========================
// You can override these in your environment or earlier in config if desired.
if (!defined('IPROGSMS_SENDER_NAME')) {
    define('IPROGSMS_SENDER_NAME', 'Smart Trashbin');
}
