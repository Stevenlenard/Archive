  ...
  <header class="header">
    <div class="header-container">
      ...
      <nav class="nav-buttons">
        <a href="#" id="navLoginBtn" class="btn btn-signup">
          ...
          <form id="registrationForm" class="auth-form">
            ...
            <div class="form-group">
              ...
              <div class="input-wrapper" style="align-items:center;gap:8px;">
                <span id="countryStatic" role="img" aria-label="Philippines" style="display:inline-flex;align-items:center;gap:8px;padding:8px 10px;border:1px solid #e2e8f0;border-radius:6px;background:#fff;min-width:64px;justify-content:center;">
                  <span style="font-size:18px;line-height:1">🇵🇭</span>
                  <span style="color:#6b7280;font-weight:600;">+63</span>
                </span>
                <input type="tel" id="phone" name="phone" placeholder="Input contact number" required style="flex:1;">
              </div>
              <small class="text-muted">Enter your 10-digit mobile number without the leading zero (e.g. 9123456789).</small>
